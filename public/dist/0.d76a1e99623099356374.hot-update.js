...
var Employee = function (_React$Component) {
  ...
  _createClass(Employee, [{
    ...
    value: function handelSubmit(event) {
      ...
      var emplist = [];
      var submitOption = (_emplist$push = emplist.push(submitOption), this.state.email = _emplist$push.email, this.state.password = _emplist$push.password, this.state.gender = _emplist$push.gender, this.state.address = _emplist$push.address, _emplist$push);
