            ...
            this.state.empList.map(function (item, index) {
              return _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    "a",
                    { href: "", onClick: props.removeItem(item.id), className: "btn btn-primary" },
                    "Delete"
                  )
                )
              );
...
var Employee = function (_React$Component) {
  ...
  function Employee(props) {
    ...
    _this.state = { id: '', email: '', password: '', gender: '', address: '', genderData: [], empList: [] };
    return _this;
  }
  ...
  _createClass(Employee, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_employeeList2.default, { removeItem: this.handleRemove.bind(this), list: this.state.empList })
      );
    }
  }]);
